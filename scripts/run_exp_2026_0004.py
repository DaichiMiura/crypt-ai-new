#!/usr/bin/env python3
"""EXP-2026-0004の日足ボリンジャーバンド平均回帰バックテストを実行する。"""
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("artifacts/EXP-2026-0004")
    )
    ...
    if not quality["interpolated_rows"]:
        raise ValueError("EXP-2026-0004 requires inherited synthetic-day markers")
    frame = prepare_bollinger_mean_reversion_signals(
    ...
    summary = {
        ...
        "method": "Bollinger mean reversion, 20-day window, 2σ population standard deviation",
