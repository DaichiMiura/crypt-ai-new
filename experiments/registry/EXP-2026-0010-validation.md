...
base feeでは、combinedの最大ドローダウンがlong-onlyより改善した年は5年中1年、
改善幅の中央値は-4.04 percentage pointsだった。short-onlyは5年合計で7件のclosed
...
|---:|---:|---:|---:|---:|---:|---:|
| 2021 | 1,349.33 | 1,031.77 | 1,392.19 | -41.76% | -39.91% | +1.85pt |
| 2022 | 1,000.00 | 904.29 | 904.29 | 0.00% | -35.10% | -35.10pt |
| 2023 | 1,113.31 | 944.94 | 1,052.01 | -26.65% | -30.69% | -4.04pt |
...
adverseとstressでも、combinedのDD改善年は各1年、改善幅中央値はそれぞれ
-4.10pt、-4.16ptだった。費用を厳しくしても判定は変わらない。

| 条件 | 結果 | 判定 |
|---|---:|---|
| combinedのDD改善が3年以上 | 1/5年 | 不合格 |
| combinedのDD改善幅中央値が正 | -4.04pt | 不合格 |
| combinedのCAGRがlong以上 | 2/5年 | 合格 |
| short-only closed round tripsが5件以上 | 7件 | 合格 |
| 棄却条件（DD改善が2年未満） | 該当 | 棄却 |

## Interpretation

今回の設定では、ショートは下落相場を安定して保護するヘッジにならなかった。
2021年と2025年には改善が見られた一方、2022〜2024年にはshortの遅い発火と反発時の
損失がロング単独より大きなDDを作った。したがって、「売りに使えるかもしれない」と
いう仮説は、少なくともこの固定条件・この価格proxyでは支持されない。
